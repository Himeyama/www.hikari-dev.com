...
![Raspberry Pi enable SSH](ssh.png)
...
![Raspberry Pi enable VNC](config.png)
...
![Raspberry Pi connect SSH](ssh-c.png)
...
![Raspberry Pi config](raspi-config.png)

3 Interface Options を選択し、P3 VNC を選択し、YES。Finish で閉じる。

## VNC で接続
![Raspberry Pi VNC viewer](vncviewer.png)

ユーザー名、パスワードは SSH のときと同様。

![Raspberry Pi VNC connected](VNC-c.png)
